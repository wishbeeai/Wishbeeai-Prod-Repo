...
export default function ActiveGiftsError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error("[Active Gifts Error]", error?.message ?? error)
  }, [error])
  ...
  return (
    <div className="min-h-screen bg-[#F5F1E8] flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-xl p-8 max-w-md w-full text-center border border-[#DAA520]/20">
        ...
        <h1 className="text-xl font-bold text-[#654321] mb-2">Couldn’t load Active Gifts</h1>

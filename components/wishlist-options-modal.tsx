                ...
                {product.productUrl && (
                  <div className="p-4 bg-gray-50 border-t border-gray-100">
                    <Button
                      ...
                      variant="outline"
                      className="w-full h-10 border-2 border-[#DAA520] text-[#DAA520] hover:bg-[#DAA520] hover:text-white font-semibold rounded-lg transition-all flex items-center justify-center gap-2"
                    >
